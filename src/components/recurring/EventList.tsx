...
import { Users, ChevronDown, ChevronUp, Calendar, Play, Video } from "lucide-react";
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  {event.recordings?.length > 0 && (
                    <Badge 
                      variant="secondary" 
                      className="flex items-center gap-1 bg-blue-100 text-blue-700 dark:bg-blue-900/50"
                    >
          ...
          {expandedEvents.has(event.id) && (
            <div className="pt-3 space-y-4 border-t mt-2">
              ...
              <div className="space-y-2">
                {isUpcoming && event.conference_url && (
                  <Button
                    variant="outline"
                    size="sm"
